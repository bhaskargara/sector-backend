...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("sector_id", sa.String(), sa.ForeignKey("sector_master.sector_id"), nullable=False),
        sa.Column("sub_sector_id", sa.String(), sa.ForeignKey("sub_sector_master.sub_sector_id"), nullable=False),
        sa.Column("status", sa.String(), nullable=False),
        sa.Column("remarks", sa.Text()),
        *timestamps(),
    )
